# -*- encoding: utf-8 -*-
# stub: railties 5.2.7.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.2.7.1/railties/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.2.7.1/railties" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<actionview>.freeze, ["= 5.2.7.1"])
  else
